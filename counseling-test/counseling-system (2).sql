...
INSERT INTO `tbl_kasus` (`id`, `NISN`, `tglKasus`, `penjelasan`, `penanganan`, `status`) VALUES
(2, 432432432, '2013-02-01', 'Mencoret Dinding Sekolah', 'Hukum berdiri di depan kelas', 'Selesai'),
(3, 432432432, '2013-09-21', 'Melawan Guru saat Menjelaskan', 'Dihukum di kantor guru', 'Selesai');
...
INSERT INTO `tbl_prestasi` (`id`, `NISN`, `tglPrestasi`, `namaPrestasi`, `tingkatPrestasi`, `peringkatPrestasi`) VALUES
(2, 432432432, '2014-06-10', 'OSN tingkat kota', 'Kota', '1'),
(3, 432432432, '1011-10-10', 'Basic Cup - Catur', 'Kota', '1');
